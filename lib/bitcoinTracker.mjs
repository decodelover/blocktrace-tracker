...
export async function fetchBitcoinWalletData(
  ...
  return {
    ...
    activity: {
      ...
      totalReceivedSats: toSafeSatsNumber(chainStats.funded_txo_sum || 0),
      totalSpentSats: toSafeSatsNumber(chainStats.spent_txo_sum || 0),
      totalReceivedBtc: toBtcString(chainStats.funded_txo_sum || 0),
      totalSpentBtc: toBtcString(chainStats.spent_txo_sum || 0),
    },
